...
ItemSet.prototype._onDragStart = function (event) {
  ...
  if (item && (item.selected || this.options.itemsAlwaysDraggable.item)) {
    ...
    if (editable.overrideItems &&
        !(editable.updateTime || editable.updatePosition) &&
        !editable.updateGroup) {
      return;
    }

    // override options.editable
    if ((item.editable != null && !(item.editable.updateTime || item.editable.updatePosition) && !item.editable.updateGroup)
  ...
  if (this.touchParams.itemProps) {
    ...
    this.touchParams.itemProps.forEach(function (props) {
      ...
      if (props.item.editable != null
        && !props.item.editable.updatePosition
      ...
      var editable = this.options.editable
      var updateTimeAllowed = ((editable.overrideItems || selectedItem.editable == null) && (editable.updateTime || editable.updatePosition)) ||
                               (!editable.overrideItems && selectedItem.editable != null && (selectedItem.editable.updateTime || editable.updatePosition));
